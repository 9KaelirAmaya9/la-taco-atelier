...
export const translations: Record<"en" | "es", Translations> = {
  en: {
    ...
    "location.checkDeliverySubtext": "Enter your address to see if we deliver to your area (15-minute delivery zone)",
  ...
  es: {
    ...
    "location.checkDeliverySubtext": "Ingresa tu dirección para ver si entregamos en tu área (zona de entrega de 15 minutos)",
